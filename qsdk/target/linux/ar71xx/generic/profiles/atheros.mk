...
define Profile/BSB002
	NAME:=Philips BSB002 board
	PACKAGES:=-swconfig -wpad-mini hostapd hostapd-utils \
	  kmod-i2c-gpio kmod-ath9k \
	  qca-legacy-uboot-bsb002
endef

define Profile/BSB002/Description
	Package set optimized for the Philips BSB002 board.
endef

$(eval $(call Profile,BSB002))
